...
class App_items_table extends App_items_table_template
{
    ...
    public function items()
    {
        ...
        foreach ($this->items as $item) {
            ...
            $itemHTML .= '<td align="right" width="' . $regularItemWidth . '%">' . floatVal($item['quantity']);

            /**
             * Maybe item has added unit?
             */
            if ($item['quantity_unit']) {
                $itemHTML .= ' ' . $item['quantity_unit'];
            }
    ...
    public function html_headings()
    {
        ...
        $html .= '<th align="right">' . $this->quantity_heading() . '</th>';
    ...
    public function pdf_headings()
    {
        ...
        $tblhtml .= '<th width="' . $regularItemWidth . '%" align="right">' . $this->quantity_heading() . '</th>';
