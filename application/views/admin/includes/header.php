        ...
        <div class="mobile-menu">
            ...
            <ul class="mobile-icon-menu">
                ...
                <li class="header-timers">
                    <a href="#" id="top-timers" class="dropdown-toggle top-timers" data-toggle="dropdown"><i class="fa fa-clock-o"></i>
...
<li class="icon header-timers">
    <a href="#" id="top-timers" class="dropdown-toggle top-timers" data-toggle="dropdown"><span data-placement="bottom" data-toggle="tooltip" data-title="<?php echo _l('project_timesheets'); ?>"><i class="fa fa-clock-o"></i></span>
      <span class="label bg-success icon-total-indicator icon-started-timers<?php if ($totalTimers = count($startedTimers) == 0){ echo ' hide'; }?>"><?php echo count($startedTimers); ?></span>
    </a>
