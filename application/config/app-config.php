...
define('APP_BASE_URL','https://crm.ublac.com/');
...
define('APP_ENC_KEY','8760b6d499db7eedf0eaf3764f20377f');
...
define('APP_DB_USERNAME','UBlacCRM_admin');
/* The password used to connect to the database */
define('APP_DB_PASSWORD','ULJUS9BuXT');
/* The name of the database you want to connect to */
define('APP_DB_NAME','UBlacCRM_db');
